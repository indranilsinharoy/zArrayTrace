...
def replicateArrayDemo(func):
    """Emulate Zemax example output of ArrayDemo.c that ships
    with Zemax. Compare the output of this funcntion, which is
    in the file named "arrayDemo.txt" with the text file 
    "arrayDemoRef.txt" that was generated by running ArrayDemo.c
